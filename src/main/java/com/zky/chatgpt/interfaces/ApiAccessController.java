package com.zky.chatgpt.interfaces;
...
public class ApiAccessController {
    ...
    /**
     * http://117.72.112.138:8080/authorize?username=zky&password=123
     */
    @RequestMapping("/authorize")
    public ResponseEntity<Map<String, String>> authorize(String username, String password) {
        Map<String, String> map = new HashMap<>();
        //模拟账户密码
        if(!"zky".equals(username) || !"123".equals(password)){
    ...
    /**
     * http://117.72.112.138:8080/verify?token=
     */
